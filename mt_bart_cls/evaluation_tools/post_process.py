...
if __name__ == "__main__":
    ...
    # with open("/ps2/sli/data/data_taowang49/projects/19_dstc11/simmc2.1_solutions/work/simmc2.1-iflytek/train_v1/1_train_model_simmc21_bart_large_20220421/test/epoch0/devtest.out", "r") as fr:
