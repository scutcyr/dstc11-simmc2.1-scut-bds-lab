...
def train(args, train_dataset, model, tokenizer, all_objects_meta):
    ...
    for epoch_i in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            loss = args.lambda_lm_loss * masked_lm_loss + \
                   args.lambda_nocoref_loss * nocoref_loss + \
            ...
            if args.local_rank in [-1, 0]:
                ...
                # logger.info("epoch: {}, global_step: {}, learning_rate: {}, loss: {}, loss_masked_lm: {}, \
                #             loss_nocoref: {}, loss_misc: {}, loss_disam: {}, loss_dst: {}".format(
                #                 str(epoch_i), str(global_step), str(scheduler.get_lr()[0]), str(loss.item()), str(masked_lm_loss.item()),
