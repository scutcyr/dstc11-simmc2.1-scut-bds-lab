...
@dataclass
class Seq2SeqLMOutputForSIMMCWithIntent(ModelOutput):
    """
    Base class for sequence-to-sequence language models outputs.
    ...
    disam_loss: Optional[torch.FloatTensor] = None
    retrieval_loss: Optional[torch.FloatTensor] = None
    user_act_loss: Optional[torch.FloatTensor] = None
    system_act_loss: Optional[torch.FloatTensor] = None
    logits: torch.FloatTensor = None
    user_act_logits: Optional[torch.FloatTensor] = None
    system_act_logits: Optional[torch.FloatTensor] = None
    disambiguation_logits: Optional[torch.FloatTensor] = None
    nocoref_logits: Optional[torch.FloatTensor] = None
    enc_head_results: Optional[List] = None
    past_key_values: Optional[Tuple[Tuple[torch.FloatTensor]]] = None
...
@dataclass
class Seq2SeqLMOutputForSIMMCJointDisamCoref(ModelOutput):
    """
    Base class for sequence-to-sequence language models outputs.
    ...
    user_act_loss: Optional[torch.FloatTensor] = None
    system_act_loss: Optional[torch.FloatTensor] = None
    disamb_and_coref_loss: Optional[torch.FloatTensor] = None
    disam_and_coref_candi_loss: Optional[torch.FloatTensor] = None
    misc_loss: Optional[torch.FloatTensor] = None
    logits: torch.FloatTensor = None
    user_act_logits: Optional[torch.FloatTensor] = None
    system_act_logits: Optional[torch.FloatTensor] = None
    disamb_and_coref_logits: Optional[torch.FloatTensor] = None
    enc_head_results: Optional[List] = None
    past_key_values: Optional[Tuple[Tuple[torch.FloatTensor]]] = None
    decoder_hidden_states: Optional[Tuple[torch.FloatTensor]] = None
    decoder_attentions: Optional[Tuple[torch.FloatTensor]] = None
