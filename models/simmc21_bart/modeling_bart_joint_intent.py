...
from .modeling_bart_outputs import Seq2SeqLMOutputForSIMMC, Seq2SeqLMOutputForSIMMCWithIntent
...
"""
PyTorch MultiTaskBartForConditionalGenerationWithDisambAndIntent Class for DSTC-11 SIMMC 2.1
Changed Based on BartForConditionalGeneration
Updated by Yirong Chen 
Used for [SIMMC 2.1](https://github.com/facebookresearch/simmc2)
Mail: [eeyirongchen@mail.scut.edu.cn](mailto:eeyirongchen@mail.scut.edu.cn)
...
class MultiTaskBartForConditionalGenerationWithDisambAndIntent(BartPretrainedModel):
    base_model_prefix = "model"
    ...
    def forward(
    ...
    ) -> Union[Tuple, Seq2SeqLMOutputForSIMMCWithIntent]:
        r"""
        ...
        loss = alpha_masked_lm_loss*masked_lm_loss + alpha_nocoref_loss*nocoref_loss + misc_loss + \
               alpha_disam_loss*disam_loss + alpha_retrieval_loss*retrieval_loss + alpha_user_act_loss*user_act_loss + alpha_system_act_loss*system_act_loss

        if not return_dict:
            return [loss,masked_lm_loss,nocoref_loss,misc_loss,disam_loss,retrieval_loss,user_act_loss,system_act_loss]
        ...
        return Seq2SeqLMOutputForSIMMCWithIntent(
            loss=loss,
