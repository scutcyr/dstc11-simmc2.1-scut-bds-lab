...
""" PyTorch Blenderbot model for DSTC-11 SIMMC 2.1
...
from .modeling_blenderbot_outputs import Seq2SeqLMOutputForSIMMC
...
"""
PyTorch MultiTaskBlenderbotForConditionalGeneration Class for DSTC-11 SIMMC 2.1
Changed Based on MultiTaskBlenderbotForConditionalGeneration
Updated by Yirong Chen 
Used for [SIMMC 2.1](https://github.com/facebookresearch/simmc2)
Mail: [yrchen5@iflytek.com](mailto:yrchen5@iflytek.com) or [eeyirongchen@mail.scut.edu.cn](mailto:eeyirongchen@mail.scut.edu.cn)
Date: 2022/08/15
...
"""
PyTorch MultiTaskBlenderbotForConditionalGeneration Class for DSTC-11 SIMMC 2.1
Changed Based on BlenderbotForConditionalGeneration
Updated by Yirong Chen 
Used for [SIMMC 2.1](https://github.com/facebookresearch/simmc2)
Mail: [yrchen5@iflytek.com](mailto:yrchen5@iflytek.com) or [eeyirongchen@mail.scut.edu.cn](mailto:eeyirongchen@mail.scut.edu.cn)
Date: 2022/08/04
...
class MultiTaskBlenderbotForConditionalGeneration(BlenderbotPreTrainedModel):
    base_model_prefix = "model"
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], *model_args, **kwargs):
        ...
        return super(MultiTaskBlenderbotForConditionalGeneration, cls).from_pretrained(
    ...
    def forward(
        ...
        # For Disambiguation
        # 由于BlenderbotTokenizerFast与BartTokenizerFast没有自动添加 EOS token
        # it doesn’t add BOS token to the beginning of sequences.
        # 因此<DISAM>的固定顺序位置为0，而不是1
