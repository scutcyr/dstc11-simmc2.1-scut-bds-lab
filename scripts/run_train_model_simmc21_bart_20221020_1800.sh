...
# File: run_train_model_simmc21_bart_20221020_1800.sh
...
# Date: 2022/10/11
# Usage:
# $ ./run_train_model_simmc21_bart_20221020_1800.sh
# 科研平台提交任务
# 任务脚本：/yrfs1/intern/yrchen5/dstc11_simmc2.1_iflytek/dstc11-simmc2.1-iflytek/scripts/run_train_model_simmc21_bart_20221020_1800.sh
# 任务日志：/yrfs1/intern/yrchen5/dstc11_simmc2.1_iflytek/dstc11-simmc2.1-iflytek/runs/run_train_model_simmc21_bart_20221020_1800.log
...
torchrun --nnodes 1 --nproc_per_node 2 --master_addr $MASTER_ADDR --master_port 9051 train_model.py \
