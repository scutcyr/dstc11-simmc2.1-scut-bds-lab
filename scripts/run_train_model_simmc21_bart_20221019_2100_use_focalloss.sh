...
# File: run_train_model_simmc21_bart_20221019_2100_use_focalloss.sh
...
# Date: 2022/10/11
# Usage:
# $ ./run_train_model_simmc21_bart_20221019_2100_use_focalloss.sh
# 科研平台提交任务
# 任务脚本：/yrfs1/intern/yrchen5/dstc11_simmc2.1_iflytek/dstc11-simmc2.1-iflytek/scripts/run_train_model_simmc21_bart_20221019_2100_use_focalloss.sh
# 任务日志：/yrfs1/intern/yrchen5/dstc11_simmc2.1_iflytek/dstc11-simmc2.1-iflytek/runs/run_train_model_simmc21_bart_20221019_2100_use_focalloss.log
...
MODEL_COMMENT=20221019_2100_use_focalloss
# cd working path
cd $WORK_DIR
...
torchrun --nnodes 1 --nproc_per_node 2 --master_addr $MASTER_ADDR --master_port 9036 train_model.py \
