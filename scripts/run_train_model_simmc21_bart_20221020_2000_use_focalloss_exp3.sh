...
# File: run_train_model_simmc21_bart_20221020_2000_use_focalloss_exp3.sh
...
# Date: 2022/10/11
# Usage:
# $ ./run_train_model_simmc21_bart_20221020_2000_use_focalloss_exp3.sh
# 科研平台提交任务
# 任务脚本：/yrfs1/intern/yrchen5/dstc11_simmc2.1_iflytek/dstc11-simmc2.1-iflytek/scripts/run_train_model_simmc21_bart_20221020_2000_use_focalloss_exp3.sh
# 任务日志：/yrfs1/intern/yrchen5/dstc11_simmc2.1_iflytek/dstc11-simmc2.1-iflytek/runs/run_train_model_simmc21_bart_20221020_2000_use_focalloss_exp3.log
...
torchrun --nnodes 1 --nproc_per_node 2 --master_addr $MASTER_ADDR --master_port 9064 train_model.py \
    ...
    --alpha_disam_loss=0.1 \
    --alpha_nocoref_loss=0.1 \
    --alpha_misc_loss=0.1 \
    --alpha_disamb_candi_loss=5.0 \
    --alpha_coref_loss=5.0 \
    --use_focal_loss \
