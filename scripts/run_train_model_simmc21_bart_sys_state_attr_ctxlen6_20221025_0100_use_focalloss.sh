...
# File: run_train_model_simmc21_bart_sys_state_attr_ctxlen6_20221025_0100_use_focalloss.sh
...
# Date: 2022/10/11
# Usage:
# $ ./run_train_model_simmc21_bart_sys_state_attr_ctxlen6_20221025_0100_use_focalloss.sh
# 科研平台提交任务
# 任务脚本：/yrfs1/intern/yrchen5/dstc11_simmc2.1_iflytek/dstc11-simmc2.1-iflytek/scripts/run_train_model_simmc21_bart_sys_state_attr_ctxlen6_20221025_0100_use_focalloss.sh
# 任务日志：/yrfs1/intern/yrchen5/dstc11_simmc2.1_iflytek/dstc11-simmc2.1-iflytek/runs/run_train_model_simmc21_bart_sys_state_attr_ctxlen6_20221025_0100_use_focalloss.log
# 模型生成路径：/yrfs1/intern/yrchen5/dstc11_simmc2.1_iflytek/dstc11-simmc2.1-iflytek/runs
# 本地多卡分布式
...
torchrun --nnodes 1 --nproc_per_node 2 --master_addr $MASTER_ADDR --master_port 9078 train_model.py \
    --model_type=mt-bart-attr \
    --model_name_or_path=/yrfs1/intern/yrchen5/pretraining_model/bart-large \
    --add_special_tokens=$INIT_DATA_DIR/simmc_special_tokens.json \
    --item2id=$INIT_DATA_DIR/item2id.json \
    --data_dir=$INIT_DATA_DIR \
    --train_input_file=$PREPROCESS_DATA_DIR/simmc2.1_dials_dstc11_train_predict_with_sys_state_ctxlen${CONTEXT_LENGTH}.txt \
    --train_target_file=$PREPROCESS_DATA_DIR/simmc2.1_dials_dstc11_train_target_ctxlen${CONTEXT_LENGTH}.txt  \
    --disambiguation_file=$PREPROCESS_DATA_DIR/simmc2.1_dials_dstc11_train_disambiguation_label.txt \
    --response_file=$PREPROCESS_DATA_DIR/simmc2.1_dials_dstc11_train_response.txt \
    --eval_input_file=$PREPROCESS_DATA_DIR/simmc2.1_dials_dstc11_devtest_predict_with_sys_state_ctxlen${CONTEXT_LENGTH}.txt \
    --eval_target_file=$PREPROCESS_DATA_DIR/simmc2.1_dials_dstc11_devtest_target_ctxlen${CONTEXT_LENGTH}.txt \
    --train_image_path_file=$PREPROCESS_DATA_DIR/simmc2.1_dials_dstc11_train_scene_name.txt \
    --train_image_dir=$INIT_DATA_DIR/simmc2_scene_images_dstc10_public \
    --eval_image_path_file=$PREPROCESS_DATA_DIR/simmc2.1_dials_dstc11_devtest_scene_name.txt \
    --eval_image_dir=$INIT_DATA_DIR/simmc2_scene_images_dstc10_public \
    --output_dir=$WORK_DIR/runs/simmc21_bart_sys_state_attr_ctxlen${CONTEXT_LENGTH}_${MODEL_COMMENT} \
    --output_eval_file=$WORK_DIR/runs/simmc21_bart_sys_state_attr_ctxlen${CONTEXT_LENGTH}_${MODEL_COMMENT}/eval_report.txt \
