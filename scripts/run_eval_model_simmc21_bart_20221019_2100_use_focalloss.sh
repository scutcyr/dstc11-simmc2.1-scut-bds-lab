...
# File: run_eval_model_simmc21_bart_20221019_2100_use_focalloss.sh
...
# Date: 2022/10/18
# Usage:
# $ ./run_eval_model_simmc21_bart_20221019_2100_use_focalloss.sh
# 科研平台提交任务
# 任务脚本：/yrfs1/intern/yrchen5/dstc11_simmc2.1_iflytek/dstc11-simmc2.1-iflytek/scripts/run_eval_model_simmc21_bart_20221019_2100_use_focalloss.sh
# 任务日志：/yrfs1/intern/yrchen5/dstc11_simmc2.1_iflytek/dstc11-simmc2.1-iflytek/runs/run_eval_model_simmc21_bart_20221019_2100_use_focalloss.log
...
python eval_model.py \
   ...
   --prompts_from_file=$PREPROCESS_DATA_DIR/simmc2.1_dials_dstc11_devtest_predict_ctxlen${CONTEXT_LENGTH}.txt \
