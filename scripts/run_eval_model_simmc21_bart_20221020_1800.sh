...
# File: run_eval_model_simmc21_bart_20221020_1800.sh
...
# Date: 2022/10/18
# Usage:
# $ ./run_eval_model_simmc21_bart_20221020_1800.sh
# 科研平台提交任务
# 任务脚本：/yrfs1/intern/yrchen5/dstc11_simmc2.1_iflytek/dstc11-simmc2.1-iflytek/scripts/run_eval_model_simmc21_bart_20221020_1800.sh
# 任务日志：/yrfs1/intern/yrchen5/dstc11_simmc2.1_iflytek/dstc11-simmc2.1-iflytek/runs/run_eval_model_simmc21_bart_20221020_1800.log
...
python eval_model.py \
   ...
   --output_json_response_path=$MODEL_SAVE_DIR/simmc21_bart_ctxlen${CONTEXT_LENGTH}_${MODEL_COMMENT}/${DATA_TYPE}_predict_results \
