...
# File: run_deveval_model_simmc21_bart_sys_state_attr_ctxlen6_20221025_0100_use_focalloss.sh
...
# Date: 2022/10/18
# Usage:
# $ ./run_deveval_model_simmc21_bart_sys_state_attr_ctxlen6_20221025_0100_use_focalloss.sh
# 科研平台提交任务
# 任务脚本：/yrfs1/intern/yrchen5/dstc11_simmc2.1_iflytek/dstc11-simmc2.1-iflytek/scripts/run_deveval_model_simmc21_bart_sys_state_attr_ctxlen6_20221025_0100_use_focalloss.sh
# 任务日志：/yrfs1/intern/yrchen5/dstc11_simmc2.1_iflytek/dstc11-simmc2.1-iflytek/runs/run_deveval_model_simmc21_bart_sys_state_attr_ctxlen6_20221025_0100_use_focalloss.log
...
python eval_model.py \
   ...
   --prompts_from_file=$PREPROCESS_DATA_DIR/simmc2.1_dials_dstc11_${DATA_TYPE}_predict_with_sys_state_ctxlen${CONTEXT_LENGTH}.txt \
